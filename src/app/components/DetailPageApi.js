...
export const DetailPageApi = (props, {
    sections = [
        {
            title: "Centralize your data models upstream, so that you only have to define them once.",
            description: 'Whether you’re building an internal application, a dashboard, or an embedded analytics application, ensure they’ll all be powered by consistent data—and skip manually orchestrating metrics for each presentation layer. Combined with Cube’s advanced caching and pre-aggregationcapabilities, this ensures that every downstream app stays updated with the latest information—cost-effectively and with low latency.',
            img: "https://cube.dev/images/product/apis-feature-0.svg",
            canvas: true
        },
        {
            title: "Seamlessly integrate using the SQL you already know.",
            description: 'Boost your data’s performance, make it consistent, and centralize its caching and security upstream of every BI platform. Cube’s instant Postgres-compliant SQL API lets you skip the new language learning curve, making it incredibly easy to connect your data sources and semantic layer to any of your downstream tools.',
            img: "https://cube.dev/images/product/apis-feature-0.svg",

        },
        {
            title: "Seamlessly integrate with every application.",
            description: 'Cube’sintegrationsand REST,GraphQL, and Postgres-compliant SQL APIs ensure compatibility with every modern data stack. Plus, reduce development context switching: manage data models in your favorite language—Python, JavaScript, or YAML—and see them visually with Data Graph.',
            img: "https://cube.dev/images/product/apis-feature-0.svg"
        },
        {
            title: "Seamlessly integrate using the SQL you already know.",
                                    ...
                                    <div className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-l__4MlQw Section--gap-none">
                                        <section className="ProductHeader_ProductHeader___JiVt">
                                            <div className="ProductHeader_ProductHeader__texts__e3MaF">
                                                ...
                                                <h2 className="ProductHeader_ProductHeader__title__7eo8B">{mainTitle}
                                                </h2>
                                                ...
                                                <div className="ProductHeader_ProductHeader__buttons__0zKBi">
                                                    <a target="__blank" href="https://cube.dev/contact" className="Button_Button__VQ4Ej Button--appearance-light ProductHeader_ProductHeader__button__fvePN Button_Button--cherry__FCGeq Button_Button--size-m__DGRm_" style={{
                                                        height: '40px',
                                                        padding: '0 16px',
                                                        fontSize: '16px',
                                                        borderRadius: '8px',
                                            ...
                                            <div
                                                class="ProductHeader_ProductHeader__media__QZkzf">
                                                <div class="HeroAnimation_HeroAnimation__llWWz">
                                                    <div class="HeroAnimation_HeroAnimation__card__IpFlG HeroAnimation_HeroAnimation__card--current__IRhY9"
                                                        style={{
                                                        ...
                                                        <img src="https://cube.dev/images/cube-scheme/badge-api.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" />
                                                        <span class="HeroAnimation_HeroAnimation__title__KFqGQ">APIs</span>
                                                    </div>
                                                    <div class="HeroAnimation_HeroAnimation__card__IpFlG" style={{
                                                        ...
                                                        <img src="https://cube.dev/images/cube-scheme/badge-data-modeling.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" />
                                                        <span class="HeroAnimation_HeroAnimation__title__KFqGQ">Data Modeling</span>
                                                    </div>
                                                    <div class="HeroAnimation_HeroAnimation__card__IpFlG"
                                                        style={{
                                                        ...
                                                        <img src="https://cube.dev/images/cube-scheme/badge-access-control.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" />
                                                    ...
                                                    <div class="HeroAnimation_HeroAnimation__card__IpFlG"
                                                        ...
                                                        <img src="https://cube.dev/images/cube-scheme/badge-caching.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" />
                                ...
                                <div>
                                    <div className="Page_Section__WvViv Page_Section--appearance-dark__Qf_N8 Page_Section--gap-xl__E8tSh Page_Section--transparent__kCYSU Product_ProductPages__Section__SHAYD">
                                        ...
                                        >
                                            ...
                                            <div
                                                className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-xs__Jdh_4 Section--gap-none"
                                                bis_skin_checked="1"
                                            >
                                                <p>
                                                    The fact that Cube’s semantic layer includes an API layer solves the many-to-many problem most organizations face. No matter the data sources and downstream apps in your stack, Cube’s instant data APIs infuse your stack with universal compatibility,{' '}
                                                    <a href="https://cube.dev/integrations">easy integrations</a>, and data accessibility.
                                                </p>
                                            </div>
                                            <div
                                                className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-l__4MlQw Section--gap-none"
                                                bis_skin_checked="1"
                                            >
                                                <img
                                                    className="Product_ProductPages__bigMedia_img_mobile__Q3C92"
                                                    src="https://cube.dev/images/product/apis.svg"
                                                    alt=""
                                                />
                                                <img
                                                    className="Product_ProductPages__bigMedia_img__sMU7n"
                                                    src="https://cube.dev/images/product/apis.svg"
                                                    alt=""
                                                />
                                            </div>
