...
function SementaticLayerBottom({
    ...
    return (
        <div style={{ marginTop: '5vh', scale: '0.87', marginBottom: '5vh' }} className="Page_SectionHeader__eXcwE Home_SectionHero__whatIs__KSXfn Page_SectionHeader--appearance-dark__hGYCv SectionHeader--level-h2">
            ...
            <div className="Page_SectionHeader__content__OvDy1">
                ...
                <br />
                <a
                    href="https://cube.dev/use-cases/semantic-layer"
                    className="Home_SectionHero__link__6RmKg"
                >
