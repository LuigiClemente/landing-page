...
export const DetailPage = ({
    ...
    titleName = "Cube's",
    list = [
        "integrations", "REST", "GraphQL", "Postgres-compliant", "SQL APIs"
    ],
                    ...
                    <section>
                        <div className="sc-bYMpWt fErNNo">
                            <div className="Product_ProductPages__backgroundWrapper__945Zw">
                                <div style={{ marginBottom: "30px" }} className="Page_Section__WvViv Page_Section--appearance-dark__Qf_N8 Page_Section--gap-xl__E8tSh Product_ProductPages__Section__SHAYD ProductPages__Section--header">
                                    <div className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-l__4MlQw Section--gap-none">
                                        <section className="ProductHeader_ProductHeader___JiVt">
                                            <div className="ProductHeader_ProductHeader__texts__e3MaF">
                                                ...
                                                <h2 className="ProductHeader_ProductHeader__title__7eo8B">
                                                    {mainTitle}
                                                </h2>
                                            ...
                                            <div
                                                ...
                                                <div class="HeroAnimation_HeroAnimation__llWWz">
                                                    <div class="HeroAnimation_HeroAnimation__card__IpFlG HeroAnimation_HeroAnimation__card--current__IRhY9"
                                                        ...
                                                        <img src="https://cube.dev/images/cube-scheme/badge-data-modeling.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" /><span class="HeroAnimation_HeroAnimation__title__KFqGQ">Data Modeling</span></div><div class="HeroAnimation_HeroAnimation__card__IpFlG" style={{
                                                        ...
                                                        <img src="/images/cube-scheme/badge-access-control.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" /><span class="HeroAnimation_HeroAnimation__title__KFqGQ">Access Control</span></div><div class="HeroAnimation_HeroAnimation__card__IpFlG" style={
                                                            {
                                                        ...
                                                        <img src="/images/cube-scheme/badge-caching.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" /><span class="HeroAnimation_HeroAnimation__title__KFqGQ">Caching</span></div><div class="HeroAnimation_HeroAnimation__card__IpFlG" style={
                                                            {
                                                        ...
                                                        <img src="/images/cube-scheme/badge-api.svg" alt="" class="HeroAnimation_HeroAnimation__badge__Iqx8u" /><span class="HeroAnimation_HeroAnimation__title__KFqGQ">APIs</span></div></div></div>
                                        </section>
                                    </div>
                                </div>
                                <div>
                                    <div className="Page_Section__WvViv Page_Section--appearance-dark__Qf_N8 Page_Section--gap-xl__E8tSh Page_Section--transparent__kCYSU Product_ProductPages__Section__SHAYD">
                                        <div className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-l__4MlQw Section--gap-none">
                                            <section className="ProductFeatureList_ProductFeatureList__zCe8z">
                                                ...
                                                <article className="ProductFeatureCard_ProductFeatureCard__B7f19 ProductFeatureCard_ProductFeatureCard--inView__4EHXT">
                                                    <div className="ProductFeatureCard_ProductFeatureCard__media__WE9Tc">
                                                        <img className="ProductFeatureCard_ProductFeatureCard__image__hYlZT" src={leftSideImage} alt="" /></div>
                                                    <div className="ProductFeatureCard_ProductFeatureCard__texts__vB9ht">
                                                        <h2 className="ProductFeatureCard_ProductFeatureCard__title__0ZCuD">
                                                            {RightSidefourthDescription}
                                                        </h2>
                                                        <div>
                                                            <p>{RightSidetitleName}
                                                                <a href="/">{list[0]} </a>
                                                                <span> and</span>  <a href="/"> {list[1]}</a>,
                                                                <a href="/">{list[2]}</a>,
                                                                and <a href="/">{list[3]}
                                                                    {list[4]}</a>
                                                                {RightSideData}
                                                ...
                                                <article className="ProductFeatureCard_ProductFeatureCard__B7f19 ProductFeatureCard_ProductFeatureCard--inView__4EHXT">
                                                    <div className="ProductFeatureCard_ProductFeatureCard__media__WE9Tc">
                                                        <img className="ProductFeatureCard_ProductFeatureCard__image__hYlZT" src={RightSideImage} alt="" /></div>
                                                    <div className="ProductFeatureCard_ProductFeatureCard__texts__vB9ht">
                                                        <h2 className="ProductFeatureCard_ProductFeatureCard__title__0ZCuD">
                                                            {fourthDescription}
                                                        </h2>
                                                ...
                                                <section id="how-does-data-modeling-with-cube-work-code-block-1" className="FeatureSection_FeatureSection__rKBQy">
                                                    <div className="FeatureSection_FeatureSection__content__QNW1v">
                                                        <div className="FeatureSection_FeatureSection__text__jloSe">
                                                            <p>
                                                                {workingSectionDescriptionOne}
                                                            </p>
                                                            <p>{workingSectionDescriptionTwo}
                                                            </p>
                                                            <p>
                                                                {workingSectionDescriptionThree}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <button className="Button_Button__VQ4Ej Button--appearance-light CodeBlocks_CodeBlocks__copy___N1Vj Button_Button--transparent___qkep Button_Button--size-s__pw3fC" type="button" >Copy</button>
                                                    </div>
                                                </section>
