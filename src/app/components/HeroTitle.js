...
function HeroTitle({ color = "#F84F39", heading = "Get things done with your" ,headingColor}) {
    return (
        <div
            style={{
            ...
            <div class="handwritten-text-wrapper">
                <div class="hero-line-embed w-embed" style={{ display: "block" }}>
                    <svg viewBox="0 0 310 199" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="team-t" d="M49.5816 21C40.9734 55.1254 18.5305 115.69 37.899 141.822" stroke={headingColor}
                            stroke-width="10" stroke-linecap="round" pathLength="1"></path>
                        <path class="team-e"
                            ...
                            stroke={color} stroke-width="10" stroke-linecap="round" pathLength="1"></path>
                        <path class="team-am"
